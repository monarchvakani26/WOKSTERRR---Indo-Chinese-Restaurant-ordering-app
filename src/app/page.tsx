      ...
      <header className="sticky top-0 z-50 bg-[var(--color-background)]/80 backdrop-blur-md border-b border-[var(--color-secondary)]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-sm font-bold">
            ...
            <Link href="/table/1" className="text-[var(--color-accent)] bg-[var(--color-accent)]/10 px-4 py-1.5 rounded-full hover:bg-[var(--color-accent)] hover:text-white transition-colors">Dine-In (Simulate Scan)</Link>
          </nav>
        </div>
      </header>
